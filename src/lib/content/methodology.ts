...
export const methodologyContent = {
    ...
    madhahSchools: {
        ...
        icon: Gavel,
        intro: "The four Sunni schools of Islamic jurisprudence—Hanafi, Maliki, Shafi'i, and Hanbali—have developed different rulings on certain Zakat matters. Understanding these differences helps you make informed choices aligned with your preferred school.",
        overview: {
            title: "What is a Madhab?",
            text: "A madhab is a school of Islamic legal thought that systematically derives rulings from the Quran, Sunnah, and other sources of Islamic law. Each school is named after its founding scholar: Imam Abu Hanifa, Imam Malik, Imam al-Shafi'i, and Imam Ahmad ibn Hanbal. While they agree on fundamental principles, they may differ on specific applications.",
            note: "ZakatFlow allows you to select your preferred madhab in Settings. If unsure, the \"Balanced (AMJA)\" option uses widely-accepted scholarly opinions."
        },
        jewelryRuling: {
            ...
            schools: [
                {
                    name: "Hanafi",
                    ruling: "Zakatable",
                    text: "Gold and silver are inherently 'growing wealth' (nāmī) by nature. Even worn jewelry is Zakatable on its melt value if it meets the nisab. This is based on general hadiths requiring Zakat on gold and silver without excluding jewelry.",
                ...
                },
                {
                    name: "Shafi'i",
                    ruling: "Exempt",
                    text: "Jewelry worn for permissible personal adornment is exempt from Zakat, as it is not held for investment or growth. However, excessive jewelry beyond customary use may be Zakatable.",
                    evidence: "Narration from Aisha (رضي الله عنها): She did not pay Zakat on the jewelry of her orphan nieces in her care. (Al-Bayhaqi)"
                },
                {
                    name: "Maliki",
                    ruling: "Exempt",
                    text: "Women's jewelry worn for beautification is exempt. Jewelry kept in storage (not worn) or held for investment is Zakatable. Men's gold jewelry (which is impermissible) is always Zakatable.",
                    evidence: "Based on the principle of personal use (qunya) exemption and the narration of Aisha."
                },
                {
                    name: "Hanbali",
                    ruling: "Exempt",
                    text: "Jewelry worn or lent to others for permissible use is exempt. Jewelry held purely for storage or investment is Zakatable.",
                    evidence: "Narrations from several companions including Ibn Umar and Jabir permitting jewelry exemption."
                }
            ],
            zakatFlowApproach: "ZakatFlow follows your selected madhab for jewelry treatment. The default 'Balanced' option follows the Hanafi precautionary (ahwat) position—paying Zakat on jewelry is the safer approach."
        },
        debtRuling: {
            title: "Debt Deduction from Zakatable Wealth",
            intro: "The schools differ significantly on whether—and to what extent—debts reduce your Zakatable wealth:",
            schools: [
                {
                    name: "Hanafi",
                    ruling: "Full deduction allowed",
                    text: "Debts payable (or installments due within 12 months) are fully deductible from Zakatable assets. If remaining wealth falls below nisab after deducting debts, Zakat is not obligatory.",
                    evidence: "Based on the principle that Zakat is due on 'net' wealth after obligations."
                },
                {
                    name: "Maliki",
                    ruling: "12-month limit",
                    text: "Only debts affecting gold, silver, and cash are deductible. Debts on trade goods, livestock, and agricultural produce are not deductible. Deduction limited to immediate obligations.",
                    evidence: "Distinguished treatment based on asset category."
                },
                {
                    name: "Shafi'i",
                    ruling: "No deduction",
                    text: "Debt does NOT prevent Zakat obligation. You must pay Zakat on your Zakatable assets even if your debts equal or exceed your total wealth.",
                    evidence: "The freedom of property from debt is not considered a condition for Zakat."
                },
                {
                    name: "Hanbali",
                    ruling: "Full deduction allowed",
                    text: "Similar to Hanafi—debts are deductible from Zakatable wealth. Zakat is only obligatory if remaining wealth after debts exceeds nisab.",
                    evidence: "Prioritizes settling obligations before Zakat calculation."
                }
            ],
            zakatFlowApproach: "ZakatFlow follows the Maliki 'middle path' as adopted by AMJA: only immediate obligations (due within 12 months) reduce your Zakatable wealth. This balances the precautionary principle with practical reality."
        },
        practicalGuidance: {
            title: "Choosing a Madhab for Zakat",
            points: [
                "If you already follow a madhab in other aspects of worship, maintain consistency for Zakat.",
                "If unsure, the precautionary approach (ahwat) is to pay more—which often aligns with Hanafi rulings on jewelry.",
                "Consult a local scholar if you have specific questions about your situation.",
                "ZakatFlow's 'Pure' calculation mode applies your selected madhab's rulings strictly."
            ]
        },
        references: [
            "Fiqh al-Zakah by Dr. Yusuf al-Qaradawi (comprehensive comparative analysis)",
            "Al-Mughni by Ibn Qudamah (Hanbali comparative fiqh)",
            "AMJA Fatwa #77832 on Zakat methodology",
            "National Zakat Foundation (UK) scholarly guidance"
        ]
    },
    nisab: {
        id: "nisab",
