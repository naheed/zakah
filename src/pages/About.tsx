  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative">
        ...
        {/* FAQ Section */}
        <StaggerContainer className="w-full max-w-3xl mt-24 mb-16" staggerDelay={0.1}>
          <StaggerItem variant="fade">
        ...
        {/* Separator */}
        <div className="w-24 h-px bg-border mb-16" />

        {/* What's New Section */}
        <StaggerContainer className="w-full max-w-2xl text-center" staggerDelay={0.1}>
          <StaggerItem variant="fade">
            <h2 className="text-2xl font-serif font-medium mb-8">What's New</h2>
          </StaggerItem>
