...
import { ArrowRight, BookOpen, Lock, Check, Calculator, DollarSign, Heart, Settings as SettingsIcon, FolderOpen, Trash2 } from "lucide-react";
    ...
    <div className="min-h-[85vh] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-6">
        <div className="w-full max-w-5xl grid md:grid-cols-2 gap-6 md:gap-12 items-start">
          {/* Left Side - Mock Report Preview (non-logged in) OR Personalized Dashboard (logged in) */}
          <div className="order-2 md:order-1">
            {user ? (
              ...
              <div className="space-y-6">
                ...
                {/* Usage Metrics - smaller for logged in */}
              ...
              // Original mock preview for non-logged in users
              <>
                <MockReportPreview />
          ...
          <div className="order-1 md:order-2 flex flex-col">
            {/* Brand Name - only for non-logged in users */}
            {!user && (
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-2 tracking-tight">
              {user ? 'Start a New Calculation' : 'Calculate Your Zakat'}
            </h1>
            ...
            <Button onClick={onNext} size="lg" className="w-full sm:w-auto gap-2 text-base h-12 mb-3">
              {user ? 'New Calculation' : 'Start Calculating'}
              <ArrowRight className="w-4 h-4" />
            </Button>
