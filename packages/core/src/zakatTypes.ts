...
export interface CalculatedAssetCategory {
    label: string;
    color: string;
    total: number;
    zakatableAmount: number;
...
export interface EnhancedAssetBreakdown {
    liquidAssets: CalculatedAssetCategory;
    preciousMetals: CalculatedAssetCategory;
    crypto: CalculatedAssetCategory;
    investments: CalculatedAssetCategory;
    retirement: CalculatedAssetCategory;
    trusts: CalculatedAssetCategory;
    realEstate: CalculatedAssetCategory;
    business: CalculatedAssetCategory;
    debtOwedToYou: CalculatedAssetCategory;
    illiquidAssets: CalculatedAssetCategory;
    liabilities: {
        label: string;
        color: string;
        total: number;
