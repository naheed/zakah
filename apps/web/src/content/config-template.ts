...
export const ZMCS_TEMPLATE: ZakatMethodologyConfig = {
    "meta": {
        "id": "zmcs-template",
        "name": "ZMCS Template",
        "version": "1.0.0",
        ...
        "scholar_url": "https://zakatflow.org",
        "reference": {
    ...
    "assets": {
        ...
        "investments": {
            ...
            "passive_investments": {
                ...
                "description": "30% proxy rule for underlying zakatable assets.",
                "scholarly_basis": "Based on AAOIFI Shariah Standard No. 9."
            },
            "reits_rate": 0.3,
            "dividends": {
                "zakatable": true,
        ...
        "retirement": {
            ...
            "post_threshold_rate": 0.3,
            "pension_vested_rate": 1,
            "penalty_rate": 0.1,
            "tax_rate_source": "user_input",
            "roth_contributions_rate": 0.3,
        ...
        "real_estate": {
            "primary_residence": {
                "zakatable": false,
                "description": "Personal home is exempt."
            },
            "rental_property": {
                "zakatable": false,
                "income_zakatable": true,
                "description": "Property value exempt. Net rental income zakatable."
            },
            "for_sale": {
                "zakatable": true,
                "rate": 1,
                "description": "Property listed for sale is trade goods."
            },
            "land_banking": {
                "zakatable": true,
                "rate": 1,
